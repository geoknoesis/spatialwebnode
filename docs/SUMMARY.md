...
* [HSTP Protocol](concepts/hstp-protocol.md)
* [Spatial Web](concepts/spatial-web.md)
* [Decentralized Identity](concepts/decentralized-identity.md)
* [Transport Bindings](concepts/transport-bindings.md)
...
* [Command Line Interface](user-guide/command-line.md)
* [Configuration Files](user-guide/configuration-files.md)
* [Transport Setup](user-guide/transport-setup.md)
* [Monitoring & Logging](user-guide/monitoring.md)

## Developer Guide

* [Developer Guide Overview](developer-guide/README.md)
...
* [Ping/Pong Example](examples/ping-pong.md)
